...
public class wk_Zahlungen extends Menu{
	...
	private Object[] line = new Object[] { "Datum", "Bezeichnung","Betrag", "Kategorie"};
	private DefaultTableModel dtm;
	private int position;
	private BudgetPlanModel bpm;
	private List<Posten> repeatlist;
	
	public wk_Zahlungen(String s, BudgetPlanModel bpm, int position){
		frame = new JFrame();
